...
package com.linversion.speedy.feature

import androidx.activity.ComponentActivity
import androidx.compose.ui.test.assertIsSelected
import androidx.compose.ui.test.junit4.createAndroidComposeRule
import androidx.compose.ui.test.onNodeWithText
import com.linversion.speedy.feature.settings.R
import com.linversion.speedy.feature.settings.SettingsDialog
import com.linversion.speedy.feature.settings.SettingsUiState.Loading
import com.linversion.speedy.feature.settings.SettingsUiState.Success
import com.linversion.speedy.feature.settings.UserEditableSettings
...
class SettingsDialogTest {
    ...
    fun whenStateIsSuccess_usesAndroidBrand_DynamicColorOptionIsNotDisplayed() {
        composeTestRule.setContent {
            SettingsDialog(
                settingsUiState = Success(
                    UserEditableSettings(brand = ThemeBrand.ANDROID, darkThemeConfig = DarkThemeConfig.DARK, useDynamicColor = false),
                ),
                onDismiss = {},
                onChangeDynamicColorPreference = {},
                onChangeThemeBrand = {},
